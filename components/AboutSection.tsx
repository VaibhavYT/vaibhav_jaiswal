...
import Vaibhav from "../public/vaibhav.png";
const AboutSection = () => {
  return (
    <section
      id="about"
      className="text-secondary pt-28 pb-28 dark:text-white relative"
    >
      ...
      <div className="flex mt-12 justify-between flex-col md:flex-row items-center md:items-start gap-12">
        <Reveal width="w-full md:max-w-[350px] h-[400px]">
          <div className="relative md:flex-1 w-full md:max-w-[350px] h-[400px] overflow-hidden rounded-lg object-cover">
            <Image className="object-cover" fill src={Vaibhav} alt="" />
          </div>
        </Reveal>
        ...
        <div className="flex md:flex-1 flex-col md:max-w-[750px]">
          ...
          <Reveal>
            <p className="font-extralight text-md md:text-lg mt-2 md:w-[85%] leading-loose">
              Hi, I’m Vaibhav, and I am passionate about creating intuitive,
          ...
          <Reveal>
            <a
              href="https://drive.google.com/file/d/1poTPqqWbbl-OleOv23N18kMBJDMsFFe8/view?usp=sharing"
              target="_blank"
